...
if(message.channel.type === 'dm') return;
 ...
 .setDescription(`
 -=-=-=-=-=-=-=-=-=-=
 🎖 ارسال رسالة لرتبة محددة بدون امبد
 
 🏅 ارسال رسالة لرتبة محددة مع امبد
 
 📭 ارسال رسالة للكل مع امبد
 
 📧 ارسال رسالة للكل بدون امبد
 
 🔵 ارسال رسالة للأونلاين بدون امبد
 
 🔷 ارسال رسالة للأونلاين مع امبد
 ...
 embedonlineonly.on('collect', r => {
    ...
    let msge;
    message.channel.send('📝 **| Please Write Now The Message To Send ✏ **').then(msg => {
   ...
   message.channel.send(`**✅ The Message Has Been Sent The Members 📢**`);
...
message.guild.members.filter(m => m.presence.status === 'online').forEach(m => {
 ...
 message.guild.members.filter(m => m.roles.get(rolecheak.id)).forEach(m => {
     ...
     cancel.on('collect', r => {
         ...
         .setTitle('Successfully Canceled ❌')
